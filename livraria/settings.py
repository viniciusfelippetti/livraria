...
SECRET_KEY = 'django-insecure-4pi+pcz$4)lm81s7ko@l#^&q(ttm2@pxywo35dc3o*3j%w%1t0'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': '',
        'HOST': 'localhost',  # Se o PostgreSQL estiver na mesma máquina, use 'localhost'
        'PORT': '5432',  # Deixe em branco para usar a porta padrão do PostgreSQL (5432)
    }
}
