          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-2439">Texto da pesquisa</label>
                <input id="searchbox-2439" type="text" placeholder="O que você procura?"/>
      ...
      <header class="br-header">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-12248">Texto da pesquisa</label>
                <input id="searchbox-12248" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
      ...
      <header class="br-header compact">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-71177">Texto da pesquisa</label>
                <input id="searchbox-71177" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
      ...
      <header class="br-header small">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-72309">Texto da pesquisa</label>
                <input id="searchbox-72309" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
      ...
      <header class="br-header large">
        <div class="container-lg">
          ...
          <div class="header-bottom">
            ...
            <div class="header-search">
              <div class="br-input has-icon">
                <label for="searchbox-94256">Texto da pesquisa</label>
                <input id="searchbox-94256" type="text" placeholder="O que você procura?"/>
                <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
                </button>
              </div>
              <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
