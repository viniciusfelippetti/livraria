      ...
      <nav class="tab-nav">
        <ul>
          <li class="tab-item notification-tooltip">
            <button type="button" aria-label="Alertas" data-panel="notification-panel-1-49587" data-tooltip-text="Alertas"><span class="name"><i class="fas fa-bell" aria-hidden="true"></i></span></button>
          </li>
          <li class="tab-item notification-tooltip active">
            <button type="button" aria-label="Mensagens" data-panel="notification-panel-2-49587" data-tooltip-text="Mensagens"><span class="name"><i class="fas fa-envelope" aria-hidden="true"></i></span></button>
          </li>
        </ul>
      </nav>
      <div class="tab-content">
        <div class="tab-panel" id="notification-panel-1-49587">
          <div class="br-list">
        ...
        <div class="tab-panel active" id="notification-panel-2-49587">
          <div class="br-list">
