    ...
    <div class="header-bottom">
      ...
      <div class="header-search">
        <div class="br-input has-icon">
          <label for="searchbox-94000">Texto da pesquisa</label>
          <input id="searchbox-94000" type="text" placeholder="O que você procura?"/>
...
<header class="br-header large">
  <div class="container-lg">
    ...
    <div class="header-bottom">
      ...
      <div class="header-search">
        <div class="br-input has-icon">
          <label for="searchbox-82956">Texto da pesquisa</label>
          <input id="searchbox-82956" type="text" placeholder="O que você procura?"/>
          <button class="br-button circle small" type="button" aria-label="Pesquisar"><i class="fas fa-search" aria-hidden="true"></i>
          </button>
        </div>
        <button class="br-button circle search-close ml-1" type="button" aria-label="Fechar Busca" data-dismiss="search"><i class="fas fa-times" aria-hidden="true"></i>
